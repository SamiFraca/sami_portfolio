...
const GRID_LAYOUT = {
  0: { colSpan: "lg:col-span-3 md:col-span-6", rowSpan: "lg:row-span-4 md:row-span-4", minHeight: "lg:h-full" },
  1: { colSpan: "lg:col-span-2 md:col-span-3", rowSpan: "md:row-span-2", minHeight: "" },
  2: { colSpan: "lg:col-span-2 md:col-span-3", rowSpan: "md:row-span-2", minHeight: "" },
  3: { colSpan: "lg:col-span-2 md:col-span-3", rowSpan: "md:row-span-1", minHeight: "" },
  4: { colSpan: "md:col-span-3", rowSpan: "md:row-span-2", minHeight: "" },
  5: { colSpan: "lg:col-span-2 md:col-span-3", rowSpan: "md:row-span-1", minHeight: "" },
} as const;

export const GlassBentoGrid = ({ items, cols = { sm: 1, md: 6, lg: 5 } }: GlassBentoGridProps) => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-5 md:grid-rows-7 gap-4 lg:gap-8 mx-auto w-full">
